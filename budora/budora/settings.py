"""
Django settings for budora project.
...
SECRET_KEY = 'django-insecure-g(&+1--q99-euo))w!$qubrg4)!hj4v5kzxuevuc3isy(099to'
...
WSGI_APPLICATION = 'budora.wsgi.application'
